...
class ActivitiesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->requirePresence('default_priority', 'create')
            ->notEmpty('default_priority');

        $validator
            ->integer('quantity_of_workers')
            ->requirePresence('quantity_of_workers', 'create')
            ->notEmpty('quantity_of_workers');
